      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button 
            ...
            className="w-full"
          >
            {isUploading ? "Uploading..." : isUploaded ? "Uploaded Successfully" : "Upload Prescription"}
          </Button>
        </form>
        ...
        {isUploaded && (
          <div className="mt-6">
            <div className="bg-green-50 border border-green-100 p-4 rounded-lg flex items-start">
              ...
              <div>
                <h4 className="font-medium text-green-800">Prescription Received!</h4>
                <p className="text-sm text-green-600 mt-1">
                  Our pharmacist will review your prescription and add the medicines to your cart
                  within 30 minutes. You'll be notified once it's ready.
                </p>
              </div>
            </div>
          </div>
