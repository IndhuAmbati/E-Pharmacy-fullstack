...
import { ArrowRight, Upload, Search, ShoppingCart, Clock, CheckCircle, Truck, ThumbsUp } from "lucide-react";
            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              <div className="space-y-4">
                <h1 className="text-3xl md:text-5xl font-bold tracking-tighter">
                  Medicines Delivered <span className="text-pharma-primary">At Your Doorstep</span>
                </h1>
                <p className="text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                  Upload your prescription or select symptoms to get medicines delivered from the nearest pharmacy. Fast, reliable, and secure.
                </p>
        ...
        <div className="py-16 bg-white">
          <div className="container px-4 md:px-6">
            <div className="text-center mb-10">
              ...
              <p className="text-gray-500 mt-2">Simple, fast, and reliable process to get your medicines</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card className="card-hover">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-gray-500">Take a photo of your prescription and upload it for our pharmacist to verify</p>
                </CardContent>
              </Card>
              ...
              <Card className="card-hover">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-gray-500">We'll add the prescribed medicines to your cart or you can select by symptoms</p>
                </CardContent>
              </Card>
              ...
              <Card className="card-hover">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-gray-500">Get medicines delivered from the nearest pharmacy to your doorstep</p>
                </CardContent>
              </Card>
            </div>
          </div>
        ...
        <div className="py-16 bg-gray-50">
          <div className="container px-4 md:px-6">
            <div className="text-center mb-10">
              ...
              <p className="text-gray-500 mt-2">See how our e-pharmacy application works step by step</p>
            </div>
            ...
            <div className="mb-8">
              <div className="flex justify-between items-center">
                {processSteps.map((step, index) => (
                  ...
                  >
                    <div className={`step ${index <= currentStep ? 'active' : ''} ${index < currentStep ? 'complete' : ''}`}>
                      {step.icon}
                    </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold">{`Step ${currentStep + 1}: ${processSteps[currentStep].title}`}</h3>
                  <p className="mt-2 text-gray-600">{processSteps[currentStep].description}</p>
                  ...
                  <div className="mt-4 flex gap-4">
                    ...
                    <Button 
                      onClick={() => setCurrentStep((prev) => Math.min(processSteps.length - 1, prev + 1))}
